...
public class UserManager {
    ...
    public void printoldestUser() {
        User oldestUser = new User("Alice", 18); //User cant be null
        for (User u : usersList) {
    ...
    public static void main(String[] args) {
        ...
        userManager.printUsersAverageAge();
//SURNAME ISN'T USED
        //NOT CORRECT DATA GIVEN TO THE PEOPLE
        ////User cant be null at print to oldest
        //Mean age is NaN ->division by 0lab
        //Sort users is dead code
        //unrelated moethod not used
    }
}